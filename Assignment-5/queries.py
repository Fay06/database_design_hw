...
collection_and_queries[3] = ('accounts', {'products': 'Commodity'}, {'_id': 1, 'account_id': 1})
...
collection_and_queries[7] = ('customers', [{'$group': {'_id': {'$month': '$birthdate'}, 'totalCount': {'$sum': 1}}}])
...
collection_and_queries[8] = ('customers', [{'$match': { 'name': {'$regex': '^[A-G]'} } }, {'$group': {'_id': {'$month': '$birthdate'}, 'totalCount': {'$sum': 1} } }])
...
###
collection_and_queries[9] = ('transactions', [{'$match': {'$expr':{'$lt':[{'$size':"$transactions"}, 10]}}}, {'$unwind': '$transactions'}])
...
collection_and_queries[10] = ('transactions', [{'$unwind': '$transactions'}, {'$group': {'_id': '$transactions.symbol', 'totalCount': {'$sum': '$transactions.amount'} } }, {'$sort' : { 'totalCount' : -1 } }])
